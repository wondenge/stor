...
// JSONCodec is a simple codec to read and write stor JSON object.
type JSONCodec struct{}

// Encode a KVPair to a stor JSON object.
func (c JSONCodec) Encode(kv *store.KVPair) (string, error) {
	b, err := json.Marshal(kv)
	return string(b), err
}

// Decode a byte slice of stor JSON object to a KVPair.
