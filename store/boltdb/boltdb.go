...
type BoltDB struct {
	...
	// By default stor opens and closes the bolt DB connection  for every
...
// Register registers boltdb to stor
func Register() {
	stor.AddStore(store.BOLTDB, New)
}
...
// by a atomic counter maintained by the stor and appened to the value passed by the client.
